        ...
        <section class="content">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('supplier.update',$data['row']->id) }}" method="post">
                        <input type="hidden" name="_method" value="PUT"/>
                        @csrf
                        <div class="form-group">
                            <label for="product_id" class="control-label">product</label>
                            <select name="product_id" class="form-control" id="product_id">
                                <option value="{{$data['row']->product_id}}">{{$data['row']->productId->name}}</option>
                        ...
                        <div class="form_group">
                            ...
                            <input type="text" class="form-control" name="password" id="password" value="{{$data['row']->password}}">
                            @error('password')
                            <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
